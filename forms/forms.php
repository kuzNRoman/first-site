<?php
		...
		$to = 'develop4web@yandex.ru'; //!!! Вставить адрес заказчика
	...
	$mail->CharSet = 'UTF-8';
	$mail->isHTML(true); 
	$mail->setFrom('noreply@'.$_SERVER['HTTP_HOST'], 'BP'); // ПИСЬМО ОТ КОГО
	$mail->addAddress($to); // АДРЕС ЗАКАЗЧИКА
	$mail->addBCC('romak2921@mail.ru');  // ДУБЛИРУЕМ 
	
	$mail->Subject = 'Жалоба BP';
	$mail->Body    = '<!DOCTYPE html>
<html>
	<body>
		<h3>Получена заявка BloggerPlace</h3>
		...
		<hr>
		<p>С наилучшими пожеланиями, <br><b>BP</b><br><br><a href="http://'.$_SERVER['HTTP_HOST'].'">'.$_SERVER['HTTP_HOST'].'</a></p>
